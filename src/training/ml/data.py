...
def process_data(X, categorical_features=[], label=None,
    ...
    ------
    X : pd.DataFrame
        Dataframe containing the features and label. Columns in `categorical_features`  # NOQA:E501
    categorical_features: list[str]
        List containing the names of the categorical features (default=[])
    label : str
        Name of the label column in `X`. If None, then an empty array will be returned  # NOQA:E501
        for y (default=None)
    training : bool
